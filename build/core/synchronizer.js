...
const encodeBigIntArray = (arr) => {
    return JSON.stringify((0, crypto_1.stringifyBigInts)(arr))
}
const decodeBigIntArray = (input) => {
    return (0, crypto_1.unstringifyBigInts)(JSON.parse(input))
}
var ActionType
;(function (ActionType) {
...
class UnirepSocialSynchronizer extends core_1.Synchronizer {
    ...
    get topicHandlers() {
        const [_UserSignedUp] =
            this.unirepSocialContract.filters.UserSignedUp().topics
        const [_PostSubmitted] =
            this.unirepSocialContract.filters.PostSubmitted().topics
        const [_CommentSubmitted] =
            this.unirepSocialContract.filters.CommentSubmitted().topics
        const [_VoteSubmitted] =
            this.unirepSocialContract.filters.VoteSubmitted().topics
        const [_AirdropSubmitted] =
            this.unirepSocialContract.filters.AirdropSubmitted().topics
        return {
            ...super.topicHandlers,
    ...
    async verifyAttestationProof(index, _epoch, db) {
        ...
        if (proof.event === 'IndexedEpochKeyProof') {
            ...
            const valid = await this.prover.verifyProof(
                ...
                publicSignals,
                (0, circuits_1.formatProofForSnarkjsVerification)(_proof)
            )
        ...
        if (existingEpkRecord) {
            db.update('EpkRecord', {
                ...
                update: {
                    spent:
                        ((_a =
                            existingEpkRecord === null ||
                            existingEpkRecord === void 0
                                ? void 0
                                : existingEpkRecord.spent) !== null &&
                        _a !== void 0
                            ? _a
                            : 0) + this.socialConfig.commentRep,
                },
            })
        } else {
            db.create('EpkRecord', {
    ...
    async postSubmittedEvent(event, db) {
        ...
        if (findPost) {
            ...
            if (decodedData !== null) {
                const postContent =
                    (_a = decodedData._postContent) !== null && _a !== void 0
                        ? _a
                        : decodedData.postContent
            ...
            if (epkRecord) {
                db.update('EpkRecord', {
                    ...
                    update: {
                        spent:
                            ((_a =
                                epkRecord === null || epkRecord === void 0
                                    ? void 0
                                    : epkRecord.spent) !== null && _a !== void 0
                                ? _a
                                : 0) +
                            _posRep +
                            _negRep,
                ...
                db.create('EpkRecord', {
                    ...
                    posRep:
                        ((_d =
                            epkRecord === null || epkRecord === void 0
                                ? void 0
                                : epkRecord.posRep) !== null && _d !== void 0
                            ? _d
                            : 0) + _posRep,
                    negRep:
                        ((_e =
                            epkRecord === null || epkRecord === void 0
                                ? void 0
                                : epkRecord.negRep) !== null && _e !== void 0
                            ? _e
                            : 0) + _negRep,
                })
            }
