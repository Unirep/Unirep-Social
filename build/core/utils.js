...
exports.UnirepSocialFactory = exports.UnirepFactory = exports.deployUnirepSocial = void 0;
const socialMedia_1 = require("../config/socialMedia");
const Unirep__factory_1 = require("../typechain/factories/Unirep__factory");
Object.defineProperty(exports, "UnirepFactory", { enumerable: true, get: function () { return Unirep__factory_1.Unirep__factory; } });
const UnirepSocial__factory_1 = require("../typechain/factories/UnirepSocial__factory");
Object.defineProperty(exports, "UnirepSocialFactory", { enumerable: true, get: function () { return UnirepSocial__factory_1.UnirepSocial__factory; } });
const deployUnirepSocial = async (deployer, UnirepAddr, _settings) => {
    ...
    console.log('-----------------------------------------------------------------');
    console.log('Bytecode size of Unirep Social:', Math.floor(Unirep__factory_1.Unirep__factory.bytecode.length / 2), 'bytes');
